...
def main():
    ...
    print("\nTotal Cash: Php ", cash_box.get_total_inserted_cash(vending_machine.money_inserted))

    #Computes and displays total change left inside the cash box
    print("Total Left Change: Php ", cash_box.get_total_left_change(vending_machine.money_inserted, ice_cream.price))
